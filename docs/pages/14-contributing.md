...
**Resources you actually read.** Page 13 only lists things somebody opened. If you add a
...
- Generic content already covered better elsewhere. Link to page 13 instead.
